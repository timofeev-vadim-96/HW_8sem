//Решение из интернет - абсолютно не понимаю, как работает. Было бы здорово, если бы объяснили, а также
// разобрали насколько оптимален код. + используются библиотеки. Как и зачем с ними работать?
